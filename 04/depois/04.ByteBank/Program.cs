...
namespace _04.ByteBank
{
    class Program
    {
        ...
        private static IList<Conta> GetContasEspeciais()
        {
            ...
            //ADICIONAR A CONTA COM SALDO MAIOR DE 5 MIL NA COLEÇÃO CONTASESPECIAIS

            //para cada cliente na coleção clientes
            foreach (Cliente cliente in clientes)
            {
                //para cada conta na colenação cliente.Contas
        ...
        private static bool ExisteContaComMaisDe50000()
        {
            ...
            //foreach(var cliente - item da coleção- in -coleção- clientes )
        ...
        private static int GetFatorial(int numero)
        {
            ...
            //-------------for---------------------//
            //for(inicialização de variável; condição; passo)
